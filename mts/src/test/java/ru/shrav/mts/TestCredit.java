...
public class TestCredit {
	...
	public static void init() {
		...
		element.click();
		WebElement element2 = driver.findElement(By.xpath("//div[2]/ul/li[3]/p"));
		element2.click();
	}

	@Test
	public void testNumber() {
		WebElement element = driver.findElement(By.xpath("//*[@id=\"score-instalment\"]"));
		String text = element.getAttribute("placeholder");
		assertEquals("Номер счета на 44", text);
	}
